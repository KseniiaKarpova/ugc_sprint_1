...
CREATE TABLE IF NOT EXISTS shard.events (
      ...
      Engine=ReplicatedMergeTree('/clickhouse/tables/shard1/events', 'replica_1') PARTITION BY toYYYYMMDD(created_at) ORDER BY id;
...
CREATE TABLE IF NOT EXISTS replica.events (
      ...
      Engine=ReplicatedMergeTree('/clickhouse/tables/shard2/events', 'replica_2') PARTITION BY toYYYYMMDD(created_at) ORDER BY id;
